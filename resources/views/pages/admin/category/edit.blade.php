            ...
            <div class="dashboard-contennt">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form id="category" action="{{ route('category.update', $item->id) }}" method="POST"
    ...
    <script>
        var locations = new Vue({
            ...
            data: {
                ...
                header_category_id: {{ $item->subHeaderCategory->header_category_id }},
                sub_header_category_id: {{ $item->sub_header_category_id }},
            },
            methods: {
